...
DIFF_ACCIDENTALS_UPPER_BOUND: float
DIFF_ACCIDENTALS_LOWER_BOUND: float
...
def initialize_values() -> None:
    ...
    global DIFF_ACCIDENTALS_UPPER_BOUND
    global DIFF_ACCIDENTALS_LOWER_BOUND
    ...
    DIFF_NOTE_AMOUNT_UPPER_BOUND = 3.25
    DIFF_NOTE_AMOUNT_LOWER_BOUND = 0.75

    DIFF_NOTE_CLASSES_UPPER_BOUND = 10 / 4
    DIFF_NOTE_CLASSES_LOWER_BOUND = 4 / 4

    DIFF_NOTE_CONCURRENT_UPPER_BOUND = 3
    DIFF_NOTE_CONCURRENT_LOWER_BOUND = 1

    DIFF_NOTE_VALUES_UPPER_BOUND = PPQN / (2 ** 2)  # Sixteenth
    DIFF_NOTE_VALUES_LOWER_BOUND = PPQN / (2 ** 0) + (PPQN / (2 ** 0)) / 2  # Midway quarter half
    ...
    DIFF_ACCIDENTALS_UPPER_BOUND = 2
    DIFF_ACCIDENTALS_LOWER_BOUND = 0
